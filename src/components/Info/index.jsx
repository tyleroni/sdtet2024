    ...
    return (
        ...
        <section className = 'admission-container'>
            ...
            <div className = 'dragon-container'>
                ...
                <div className = 'hours-container'>
                    ...
                    <p className = 'p1-info'>Carnival will need paid tickets for rides.</p>
        ...
        <section className = 'directions-container'>
            ...
            <div className = 'address-parking-container'>
                <div className = 'address-container'>
                    ...
                    <p className = 'address-p paragraph'>2455 Cushing Rd, San Diego, CA 92106</p>
                ...
                <div className = 'parking-container'>
                    ...
                    <p className = 'parking-p paragraph'>Parking is limited at the festival. Respectfully use nearby parking, but note that Mira Mesa High School may charge a fee.</p>
                    <p className = 'parking-p paragraph'>Carpooling or ride-sharing is strongly suggested!</p>
                </div>
            </div>
        </section>
        <section className = 'festival-section'>
            ...
            <div className = 'rules-container'>
                <div className = 'rules-list'>
                    ...
                    <li className = 'rules'>NO <span>weapons</span></li>
                    <li className = 'rules'>NO <span>hoverboards or drones</span></li>
                    <li className = 'rules'>NO <span>fireworks</span></li>
                    <li className = 'rules'>NO <span>smoking or e-cigarettes/vapors</span></li>
                    <p className = 'rules-p paragraph'>We Reserve the Right to Refuse Entry for Violating the Rules</p>
                    <p className = 'rules-p paragraph'>Pets are okay! But they must be leashed.</p>
                </div>
            ...
            <div className = 'highlights-container'>
                <div className = 'performances card-highlight'>
                    <a href ='/' target ='_blank'>
                        <img src = {performance} className = 'performance-img sample-highlight' alt = 'performance image'></img>
                        <h2 className='performance card-h2'>Performances</h2>
                    </a>
                </div>
                <div className = 'miss-vietnam card-highlight'>
                    <a href ='/' target ='_blank'>
                        <img src = {missvietnam} className = 'missvietnam-img sample-highlight' alt = 'missvietnam image'></img>
                        <h2 className = 'miss-vietnamh2 card-h2'>Miss Vietnam San Diego</h2>
                    </a>
                </div>
                <div className = 'vendors2 card-highlight'>
                    <a href ='/'>
                        <img src = {vendor} className = 'vendor-img sample-highlight' alt = 'vendor image'></img>
        ...
        <section className = 'instagram-section'>
            ...
            <div className = 'sdtf-img-container'>
                <a href ='instagram'>
                    <img src = {insta1} className = 'insta1-img insta-img sample' alt = 'insta1 image'></img>
               </a>
                <a href ='instagram'>
                    <img src = {insta2} className = 'insta2-img insta-img sample' alt = 'insta2 image'></img>
                </a>
                <a href ='instagram'>
                    <img src = {insta3} className = 'insta3-img insta-img sample' alt = 'insta3 image'></img>
                </a>
                <a href ='instagram'>
                    <img src = {insta4} className = 'insta4-img insta-img sample' alt = 'insta4 image'></img>
                </a>
            </div>
        </section>
