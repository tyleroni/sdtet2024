      ...
      <section className="volunteer-info-section">
        <div className="volunteer-info-container-parent">
          ...
          <div className="volunteer-info-container">
            ...
            <p className="paragraph volunteer-paragraph1">
              We are looking for friendly, helpful, reliable volunteers to help
              with this exciting festival. Our festival will be filled with
              people of all ages. If you were at the festival last year, then
              you have a general idea of how big it will be this year and how
              much fun everyone will have. If you didn’t attend the festival
              last year, then here is an opportunity for you to come and help
              make this upcoming festival even bigger and better!
            </p>
            <p className="paragraph volunteer-paragraph2">
              Questions? Contact us at <span>volunteer@sdtet.com</span>
            </p>
            <div className="volunteer-button-container1 volunteer-button-container">
              <a
                ...
                target="_blank"
                className="apply-volunteer-btn"
              >
                REQUIRED: CONSENT AND LIABILITY RELEASE FORM
              </a>
            </div>
            <div className="volunteer-button-container2 volunteer-button-container">
              <a
                ...
                target="_blank"
                className="apply-volunteer-btn optional-app-btn"
              >
                OPTIONAL: HOURS VERIFICATION FORM
              </a>
            </div>
            <div className="volunteer-button-container3 volunteer-button-container">
              <a
                href="https://discord.gg/VmQHJWQZYH"
                target="_blank"
                className="apply-volunteer-btn optional-app-btn"
              >
                JOIN OUR DISCORD
