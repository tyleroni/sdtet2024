    ...
    <>
      ...
      <section className="mvsd-info-section">
        <div className="mvsd-info-container">
          <h1 className="h1-font-mvsd mvsd-pageant">
            {" "}
            WHAT IS THE MISS VIETNAM SD PAGEANT
          </h1>
          <p className="paragraph1 pageant-description">
            Established in 2006 by The Vietnamese American Youth Alliance
            (VAYA), Miss Vietnam San Diego celebrates the beauty and cultural
            heritage of the Vietnamese community in San Diego. Our mission is to
            unite and strengthen the community through women’s empowerment,
            leadership, and service. In providing a platform and mentorship for
            youth and goodwill ambassadors, we cultivate community role models
            and leaders.
          </p>
          <h1 className="h1-font-mvsd mvsd-apply-info">
            {" "}
            WHY YOU SHOULD APPLY FOR MVSD!
          </h1>
          <p className="paragraph1 pageant-apply-description">
            Miss Vietnam San Diego represents the beauty of the Vietnamese
            community in San Diego, beauty inside and out. Miss Vietnam San
            Diego is kind, intelligent, and proud of their heritage. Miss
            Vietnam San Diego always puts the community first.
          </p>
        </div>
          ...
          <div className="flex-container1">
            ...
            <div className="reason2 reason">
              ...
              <h2 className="explanation">
                Develop perosnal & professional skills
              </h2>
            </div>
            <div className="reason3 reason">
              <h2 className="number">03 / </h2>
              <h2 className="explanation longexplanation">
                Boost self-efficacy and captivating presentations skills
              </h2>
            </div>
            <div className="reason4 reason">
              <h2 className="number">04 / </h2>
              <h2 className="explanation">
                Engage with the Vietnamese community
              </h2>
            </div>
            <h1 className="h1-font-mvsd how-to-apply">HOW TO APPLY</h1>
            <p className="paragraph1 how-to-apply-description">
              Applications for this year's cohort have unfortunately closed.
              Please stay tuned in the future for updates!
            </p>
            {/* <a href="/" className="apply-btn">
              VISIT MVSD FOR MORE INFO
            </a> */}
          </div>
          <div className="flex-container2">
            <img
              src={decoration3}
              className="decoration3 nonresponsive-mvsd"
            ></img>
          </div>
        </div>
      </section>
      {/* <section className="mvsd-dates-section">
        ...
        <div className="dates1-container dates-container">
          <div className="decoration4-container">
            <img
              src={decoration4}
              className="decoration4 nonresponsive-mvsd"
            ></img>
          </div>
        ...
        <div className="dates2-container dates-container">
          <div className="decoration5-container">
            <img
              src={decoration5}
              className="decoration5 nonresponsive-mvsd"
            ></img>
          </div>
          ...
          <div className="decoration6-container">
            <img
              src={decoration6}
              className="decoration6 nonresponsive-mvsd"
            ></img>
          </div>
        </div>
      </section> */}
      <section className="mvsd-instagram-section">
        ...
        <p className="sdtf-p paragraph2 sdtf-margin">
          Follow @missvietnamsandiego on Instagram to see their latest updates!
        </p>
        <div className="sdtf-img-container">
          <a href="instagram">
            <img
              src={mvsdinsta1}
              className="mvsdinsta1-img insta-img sample"
              alt="insta1 image"
            ></img>
          </a>
          <a href="instagram">
            <img
              src={mvsdinsta2}
              className="mvsdinsta2-img insta-img sample"
              alt="insta2 image"
            ></img>
          </a>
          <a href="instagram">
            <img
              src={mvsdinsta3}
              className="mvsdinsta3-img insta-img sample"
              alt="insta3 image"
            ></img>
          </a>
          <a href="instagram">
            <img
              src={mvsdinsta4}
              className="mvsdintsa4-img insta-img sample"
              alt="insta4 image"
            ></img>
          </a>
        </div>
